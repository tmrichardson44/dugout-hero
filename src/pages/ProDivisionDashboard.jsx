  ...
  return (
    <div className="bg-white border border-slate-200  rounded-[28px] border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(16,185,129,0.1)] transition-all duration-300 overflow-hidden group hover:shadow-lg hover:border-emerald-200 transition-all">
      <div className="p-6 pb-4">
        ...
        {hasCoach ? (
          <div className="flex items-center gap-2 bg-white/40  border border-slate-100 px-3 py-1.5 rounded-xl mb-3">
          ...
          <div className="flex items-center gap-2 bg-white/40  border border-slate-100 px-3 py-1.5 rounded-xl mb-3 opacity-60">
      ...
      {showCoachModal && (
        <div className="fixed inset-0 bg-slate-900/50  z-[200] flex items-center justify-center p-4" onClick={() => setShowCoachModal(false)}>
          <div className="bg-white border border-slate-200  rounded-[28px] p-8 w-full max-w-sm shadow-lg animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
            ...
            <select
              className="w-full bg-white/40  border border-slate-200 rounded-lg px-5 py-3 font-bold text-slate-700 outline-none focus:border-slate-500 transition-all mb-4"
            ...
            {assignCoachMode === 'new' && (
              <>
                ...
                <input
                  ...
                  className="w-full bg-white/40  border border-slate-200 rounded-lg px-5 py-3 font-bold text-slate-700 outline-none focus:border-slate-500 transition-all mb-2"
...
export default function ProDivisionDashboard() {
  ...
  if (loading || !division) {
    return <div className="min-h-screen bg-white/40  flex items-center justify-center"><div className="w-8 h-8 border-4 border-slate-500 border-t-transparent rounded-full animate-spin" /></div>;
  }
  ...
  return (
    <div className="min-h-screen bg-white/40 ">
      <nav className="bg-slate-600 text-white p-4 flex items-center justify-between shadow-lg sticky top-0 z-50">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="bg-slate-700 hover:bg-slate-800 text-white text-[10px] font-bold px-4 py-2 rounded-xl transition-colors flex items-center gap-2 tracking-wide font-medium"
          >
      ...
      <main className="max-w-6xl mx-auto p-6 space-y-8">
        ...
        {teams.length === 0 ? (
          <div className="bg-white border border-slate-200  rounded-xl p-16 flex flex-col items-center justify-center border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgba(16,185,129,0.1)] transition-all duration-300 mt-8">
      ...
      {showAddTeam && (
        <div className="fixed inset-0 bg-slate-900/50  z-[100] flex items-center justify-center p-4" onClick={() => setShowAddTeam(false)}>
          <div className="bg-white border border-slate-200  rounded-xl p-8 w-full max-w-md shadow-lg animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
            ...
            <input
              className="w-full bg-white/40  border border-slate-200 rounded-lg px-5 py-3 font-bold text-slate-700 outline-none focus:border-slate-500 transition-all mb-4 text-sm"
