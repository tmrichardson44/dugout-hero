        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input className="w-full bg-slate-50 border border-slate-200 rounded-[20px] px-6 py-4 font-black text-slate-700 outline-none focus:bg-white focus:border-emerald-500 transition-all uppercase placeholder:normal-case" placeholder="Team Name" value={draft.teamName || ''} onChange={(e) => setDraft({...draft, teamName: e.target.value})} />
            </div>
            
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Program</label>
              <select className="w-full bg-slate-50 border border-slate-200 rounded-[20px] px-6 py-4 font-black text-slate-700 outline-none focus:bg-white focus:border-emerald-500 transition-all appearance-none cursor-pointer" value={draft.program || 'Independent'} onChange={(e) => setDraft({...draft, program: e.target.value})}>
          ...
          <div className="bg-slate-50 p-6 rounded-[32px] space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input type="number" className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 font-black outline-none" value={draft.rosterSize || 12} onChange={(e) => setDraft({...draft, rosterSize: parseInt(e.target.value) || 0})} />
              </div>
              <div className="space-y-2">
    ...
    <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
       ...
       {isAdding && (
         <div className="bg-white p-6 rounded-[32px] border-2 border-emerald-500 shadow-xl space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
               <button onClick={() => setNewPlayer({...newPlayer, willPitch: !newPlayer.willPitch})} className={`py-3 rounded-2xl font-black text-xs uppercase tracking-widest transition-all border-2 ${newPlayer.willPitch ? 'bg-blue-50 border-blue-500 text-blue-700' : 'bg-slate-50 border-slate-100 text-slate-400'}`}>Pitcher</button>
...
export default function DugoutHeroCore({
  ...
  return (
    <>
      <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-24 no-print relative w-full h-full max-h-screen overflow-y-auto">
             ...
             <div className="space-y-4">
                <div className="bg-white p-6 rounded-[32px] border border-slate-200 shadow-sm space-y-4 animate-in slide-in-from-top-4 duration-500">
                  <div className="flex items-center justify-between border-b border-slate-50 pb-4">
                    <div className="flex items-center gap-4">
                       <button onClick={() => onUpdateGame(selectedGame.firebaseId, { isHome: !selectedGame.isHome })} className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${selectedGame.isHome ? 'bg-emerald-50 text-emerald-600' : 'bg-slate-50 text-slate-400'}`}>
                ...
                {gameSubTab === 'matrix' && (
                  <div className="bg-white p-6 rounded-[32px] border border-slate-200 shadow-sm space-y-6 animate-in slide-in-from-left-4 duration-300">
                    <div className="flex items-center justify-between">
                       ...
                       <button onClick={autoGenerateField} className="bg-blue-50 text-blue-600 px-4 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:bg-blue-100 transition-colors active:scale-95">
                                    ...
                                    <div className="flex items-center gap-3">
                                      ...
                                      <div>
                                        ...
                                        <div className="flex items-center gap-1 mt-1">
                                          ...
                                          {p.willPitch && <span className="text-[8px] bg-blue-50 text-blue-600 px-1 py-0.5 rounded-sm font-black uppercase tracking-widest leading-none">P</span>}
                ...
                {gameSubTab === 'order' && (
                  <div className="bg-white p-6 rounded-[32px] border border-slate-200 shadow-sm space-y-6 animate-in slide-in-from-right-4 duration-300">
                    <div className="flex items-center justify-between">
                       ...
                       <button onClick={autoGenerateOrder} className="bg-blue-50 text-blue-600 px-4 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:bg-blue-100 transition-colors active:scale-95">
                         <Wand2 className="w-4 h-4" /> Auto-Balance
                       </button>
                    </div>
                    <div className="space-y-2">
                ...
                {gameSubTab === 'preview' && (
                  <div className="animate-in slide-in-from-right-4 duration-300">
                    <div className="flex justify-between items-center bg-blue-600 p-6 rounded-[32px] shadow-xl mb-4">
                      ...
                      <button onClick={() => window.print()} className="bg-white text-blue-600 px-6 py-3 rounded-2xl font-black text-xs shadow-lg active:scale-90 transition-all flex items-center gap-2"><Printer className="w-4 h-4" /> EXPORT PDF</button>
                    </div>
