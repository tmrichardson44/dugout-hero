...
import ProDivisionDashboard from './pages/ProDivisionDashboard';
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          {/* Division Admin Dashboard Route */}
          <Route path="/pro/division/:divisionId" element={
             <ProtectedRoute>
                <ProDivisionDashboard />
             </ProtectedRoute>
          } />
